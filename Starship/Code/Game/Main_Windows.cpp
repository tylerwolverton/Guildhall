...
const char* APP_NAME = "SD1-A3: Starship Gold";	    // ...becomes ??? (Change this per project!)
...
LRESULT CALLBACK WindowsMessageHandlingProcedure( HWND windowHandle, UINT wmMessageCode, WPARAM wParam, LPARAM lParam )
{
	switch( wmMessageCode )
	{
		...
		case WM_KEYDOWN:
		{
			...
			// #SD1ToDo: Tell the InputSystem about this key-pressed event...
			break;
		}
		...
		case WM_KEYUP:
		{
			...
			// #SD1ToDo: Tell the InputSystem about this key-released event...
			break;
		}
	}
