...
private:
	...
	void		AddHorizontalTile( Map& map, Vec2& curPos, float nextTileStep, IntVec2& remainingPathLength );
	void		AddVerticalTile( Map& map, Vec2& curPos, float nextTileStep, IntVec2& remainingPathLength );
