...
#define AABB2_Mins							mins		
#define AABB2_Maxs							maxs		
...
#define Function_ClampFloat					ClampMinMax
#define Function_ClampFloatZeroToOne		ClampZeroToOne
#define Function_RoundDownToInt				RoundDownToInt

#define Function_GetShortAngDisp			GetShortestAngularDisplacementDegrees
