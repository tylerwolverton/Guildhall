...
private:
	...
	void WarpEntity( EventArgs* args );
	void StartNewTimer( EventArgs* args );
	void GetTimerRemaining( EventArgs* args );
	void TriggerGameOver( EventArgs* args );
	void WinGame( EventArgs* args );

	// Entity Events
	void DestroySelf( EventArgs* args );
	void MarkAsGarbage( EventArgs* args );
	void DamageEntity( EventArgs* args );
	void CheckForCrit( EventArgs* args );
	...
	void PickupItem( EventArgs* args );
	...
	void DamageEntitiesInCircle( EventArgs* args );
	...
	// Math
	void AreVectorsNearlyEqual( EventArgs* args );
	void DoDiscsOverlap( EventArgs* args );
