...
void World::AddEntityFromDefinition( const EntityDefinition& entityDef )
{
	...
	switch ( entityDef.GetClass() )
	{
		...
		case eEntityClass::ACTOR_SPAWNER:	{ newEntity = new ActorSpawner( entityDef, nullptr ); }		break;
		...
		case eEntityClass::ITEM:			{ newEntity = new Item( entityDef, nullptr ); }		break;
