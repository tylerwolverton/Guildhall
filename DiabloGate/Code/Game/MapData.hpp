...
private:
	...
	bool ParseEntityLegendNode( const XmlElement& mapDefElem, std::map<char, EntityDefinition*>& legend, const std::string& defaultRegionName );
	bool ParseEntityRowsNode( const XmlElement& mapDefElem, const std::map<char, EntityDefinition*>& legend, const std::string& defaultRegionName );
